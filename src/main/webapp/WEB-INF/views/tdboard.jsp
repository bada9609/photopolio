...
<table border="1" style="border-color: #1f4568;">
  <tr>
  	<td>
  		<a href="tdboard?page=1">최근목록</a>&nbsp;
  	</td>
  </tr>
</table>
<table border="1" style="border-color: #1f4568;">
  <tr>
  	<th>글번호</th><th>환자번호</th><th>제목</th><th>작성일</th><th>상세보기</th><th>진단서</th>
  </tr>
  ...
  <tr>
  	...
  	<td style="text-align: center;">${tab}<a href="tdboard_detail?tp_num=${b.tp_num}&page=${page}">보기</a></td>
  	<td style="text-align: center;"><a href="reply?tp_num=${b.tp_num}&page=${page}">${b.td_check }</a></td>
  </tr>
   </c:forEach>
