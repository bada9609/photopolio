	...
	<header class="header">
		<div class="container header__container">
			...
			<ul class="nav">
				...
				<li class="button-dropdown"><a href="javascript:void(0)"
					class="dropdown-toggle"> 의사서비스<span>▼</span>
				</a>
					<ul class="dropdown-menu">
						<li><a href="tdboard?page=1"> 홈닥터 접수내역 </a></li>
						<li><a href="dappoint_list"> 진료예약 접수내역</a></li>
				...
				<%}else{ %>
				<li class="header__el header__el--blue"><a href="dlogout" class="btn btn--white">로그아웃</a></li>
				<%} %>
